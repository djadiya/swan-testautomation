...
testbedjson = {"platform": 9000, "devices": [{"name": "WAN_EGRESS", "role": "", "ip": "172.26.228.190", "telnetPort": 10974, "sshPort": 60524}, {"name": "SWAN_EGRESS", "role": "", "ip": "172.26.228.190", "telnetPort": 12190, "sshPort": 63756}, {"name": "SWAN_PHP", "role": "", "ip": "172.23.164.2", "telnetPort": 20452, "sshPort": 63081}, {"name": "SWAN_MIDPOINT", "role": "", "ip": "172.23.164.2", "telnetPort": 18381, "sshPort": 63410}, {"name": "SWAN_INGRESS", "role": "", "ip": "172.26.228.190", "telnetPort": 23026, "sshPort": 64934}, {"name": "WAN_INGRESS", "role": "", "ip": "172.26.228.190", "telnetPort": 19020, "sshPort": 61793}]}

def rntestbedjsongen(testbedjson):
    genobj = (line for line in testbedjson['devices'])
    return genobj
def rnaddrouterobj(filterlst=[], testbedjson=testbedjson):
    addrouterobjs = []
